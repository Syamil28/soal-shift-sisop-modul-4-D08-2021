...
static char *dirpath = "/home/syamil/Downloads";
static char *logpath = "/home/syamil/SinSeiFS.log";
...
void log_v1(char *from, char *to) {
    ...
    if (strstr(to + i, ATOZ) || strstr(to + i, RX) == NULL) return;
